...
"""
DESCRIPTION:
    This sample demonstrates an async Weather Agent using real OpenWeatherMap API.
    The agent uses function calling to provide actual weather information.

USAGE:
    python weather_agent_async.py

    Before running the sample:

    pip install "azure-ai-projects>=2.0.0b1" python-dotenv httpx aiohttp
